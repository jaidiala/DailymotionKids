...
import com.orange.labs.dailymotion.kids.billing.BillingConsts.ResponseCode;
import com.orange.labs.dailymotion.kids.billing.BillingSecurity.VerifiedPurchase;
...
public class BillingHelper {
	...
	public static boolean isBillingSupported() {
		...
		if (mService != null) {
			try {
				...
				KidsLogger.i(LOG_TAG, "isBillingSupported response was: " + code.toString());
				...
				KidsLogger.e(LOG_TAG, "isBillingSupported response was: RemoteException - " + e);
				return false;
			}
		} else {
			KidsLogger.i(LOG_TAG, "isBillingSupported response was: BillingService.mService = null");
			return false;
		}
	}
	...
	public static void requestPurchase(Context activityContext, String itemId){
		...
		KidsLogger.i(LOG_TAG, "requestPurchase()");
		...
		try {
			...
			KidsLogger.i(LOG_TAG, "current request is:" + requestIndentifier);
			BillingConsts.ResponseCode responseCode = BillingConsts.ResponseCode.valueOf(responseCodeIndex);
			KidsLogger.i(LOG_TAG, "REQUEST_PURCHASE Sync Response code: "+responseCode.toString());
			
			startBuyPageActivity(pendingIntent, new Intent(), activityContext);
		} catch (RemoteException e) {
			KidsLogger.e(LOG_TAG, "Failed, probably internet error - " + e);
			KidsLogger.e(LOG_TAG, "Billing supported: "+isBillingSupported());
		}
	}
	...
	protected static void getPurchaseInformation(String[] notifyIds){
		...
		KidsLogger.i(LOG_TAG, "getPurchaseInformation()");
		...
		try {
			...
			Integer responseCodeIndex 	= (Integer) response.get("RESPONSE_CODE");
			BillingConsts.ResponseCode responseCode = BillingConsts.ResponseCode.valueOf(responseCodeIndex);
			KidsLogger.i(LOG_TAG, "GET_PURCHASE_INFORMATION Sync Response code: "+responseCode.toString());
	...
	protected static void confirmTransaction(String[] notifyIds) {
		...
		KidsLogger.i(LOG_TAG, "confirmTransaction()");
		...
		try {
			...
			KidsLogger.i(LOG_TAG, "CONFIRM_NOTIFICATIONS Sync Response code: "+responseCode.toString());
		} catch (RemoteException e) {
			KidsLogger.e(LOG_TAG, "Failed, probably internet error - " + e);
			KidsLogger.e(LOG_TAG, "Billing supported: " + isBillingSupported());
		}
	...
	public static void restoreTransactionInformation(Long nonce) {
		...
		try {
			...
			Integer responseCodeIndex 	= (Integer) response.get("RESPONSE_CODE");
			BillingConsts.ResponseCode responseCode = BillingConsts.ResponseCode.valueOf(responseCodeIndex);
			KidsLogger.i(LOG_TAG, "RESTORE_TRANSACTIONS Sync Response code: "+responseCode.toString());
		} catch (RemoteException e) {
			KidsLogger.e(LOG_TAG, "Failed, probably internet error - " + e);
			KidsLogger.e(LOG_TAG, "Billing supported: " + isBillingSupported());
		}
	...
	private static boolean amIDead() {
		if (mService == null || mContext == null) {
			KidsLogger.e(LOG_TAG, "BillingHelper not fully instantiated");
			return true;
		} else {
			return false;
		}
	...
	private static Bundle makeRequestBundle(String method) {
		...
		request.putInt("API_VERSION", 2); // subs require API version 2
	...
	private static void startBuyPageActivity(PendingIntent pendingIntent, Intent intent, Context context){
		...
		try {
			...
			KidsLogger.e(LOG_TAG, "startBuyPageActivity CanceledException");
		}
	}
	...
	protected static void verifyPurchase(String signedData, String signature) {
		...
		if(purchases != null && !purchases.isEmpty()){
			...
			KidsLogger.e(LOG_TAG, "verifyPurchase error. BillingSecurity return an empty or null purchases array");
		}		
		
		if(mCompletedHandler != null){
			mCompletedHandler.sendEmptyMessage(0);
		} else {
			KidsLogger.e(LOG_TAG, "verifyPurchase error. Handler not instantiated. Have you called setCompletedHandler()?");
		}
	}
	...
	public static void stopService(){
		...
		KidsLogger.i(LOG_TAG, "Stopping Service");
	}
}
